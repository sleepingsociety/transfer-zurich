        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="pageContent">
                    <div class="row">
                        <div id="allTasks" class="table-responsive">
                            <table id="selectViewTable">
                                <tr>
                                    <td onclick="changeAllTasksTable('past')" id="pastAllTasks">Geschehenes</td>
                                    <td onclick="changeAllTasksTable('today')" id="todayAllTasks">Heute</td>
                                    <td onclick="changeAllTasksTable('week')" id="weekAllTasks">Woche</td>
                                    <td onclick="changeAllTasksTable('month')" id="monthAllTasks">Monat</td>
                                </tr>
                            </table>
                            <table id="allTaksTable">
                                <thead>
