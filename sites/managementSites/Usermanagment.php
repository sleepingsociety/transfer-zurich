    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="pageContent">
                ...
                <?php
                if ($_SESSION['username'] == "dkalchofner"){
                    ?>
                    <div id="createNewUserButton">
                        <form action="../../register.php">
                            <button class="btn btn-default" type="submit" value="createNewUserButton">Neuen Benutzer
                                erstellen
                            </button>
                        </form>
                    </div>
                ...
                ?>
                <div id="createNewUserButton">
                    <?php echo 'Sie haben keine Berechtigung neue Benutzer zu erstellen.'; ?>
                </div>
                <?php } ?>
            </div>
        </div>
