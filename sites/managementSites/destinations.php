            ...
            <div class="pageContent row">
                <div class="col-md-6 col-sm-6 col-lg-6">
                    ...
                    if (isset($_POST["addDestination"])) {
                        ...
                        $sql = "INSERT INTO destination (destination, country_fs, region_fs, breaks, traffic_jam_surcharge, search_at_place, type_fs, maut_fs)
                        VALUES ('$destination', '$country', '$region', '$breaks','$traffic_jam_surcharge','$search_on_site', '$type_id', '$maut_auswahl')";
                ...
                <form method="post" action=" <?php echo $_SERVER['PHP_SELF']; ?> ">
                    ...
                    <div class="row">
                        ...
                        <button name="confirmDestinationButton" class="btn btn-default" type="submit" value="saveEdits">
                            Auswählen
                        </button>
                    </div>
                </form>
