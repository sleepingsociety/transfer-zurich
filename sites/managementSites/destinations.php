                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            <div class="row">
                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <input id="destination_id_add_destination" type="text" class="form-control" name="destination">
                                </div>
                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                ...
                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <input id="destination_id_add_zipCode" type="text" class="form-control" name="zipCode">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <input id="destination_id_add_traffic_jam_surcharge" type="text" class="form-control" name="traffic_jam_surcharge">
                                </div>
                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                    <label for="destination_id_add_search_on_site">Suche vor Ort</label><br>
                                    <input id="destination_id_add_search_on_site" type="text" class="form-control" name="search_on_site">
                                </div>
                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                    <label for="destination_id_add_breaks">Pausen</label><br>
                                    <input id="destination_id_add_breaks" type="text" class="form-control" name="breaks">
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6">
                    ...
                    if (isset($_POST["confirmDestinationButton"])) {
                        ...
                        if (!get_magic_quotes_gpc()) {
                            ...
                            $country_ID = addslashes($_POST["destination_id"]);

                        } else {
                            $country_ID = $_POST["destination_id"];
                        }
