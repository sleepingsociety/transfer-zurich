...
CREATE TABLE destinations (
  ...
  country_fs VARCHAR(255) NOT NULL,
  region_fs VARCHAR(255) NOT NULL,
...
CREATE TABLE income_transfer (
  ...
  small_children_seats VARCHAR(20),
  children VARCHAR(20),
  booster VARCHAR(20),
  ...
  price_exkl_prov_eur FLOAT,
  price_exkl_prov_chf FLOAT,
  cash VARCHAR(20),
  paypal VARCHAR(20),
  bank VARCHAR(20),
  ...
  trailer BOOLEAN,
  driver_departed BOOLEAN,			/*Theoretisch gesehen machen diese driver_... keinen Sinn da man den Auftrag ja nicht während der Fahrt bekommt 												und er dann unterwegs ist, man könnte in der DB eine Spalte machen mit status und dann villeicht per 														Button/Dropdown auf der Webseite den aktuellen Status bestimmen.*/
  driver_on_the_way BOOLEAN,
  driver_arrived BOOLEAN,
  driver_on_the_way_back BOOLEAN,
  driving_time VARCHAR(255),		/*Irgendwie berechnet werden oder aus der Route vom Bild genommen*/
  confirmation_date DATE,
  confirmation_time TIME,
  price_inkl_prov_eur FLOAT,
  price_inkl_prov_chf FLOAT,
